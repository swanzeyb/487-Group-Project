...
public class GameOverScreen : IScreen
{
    ...
    public GameOverScreen(SpriteFont titleFont, SpriteFont defaultFont)
    {
        _titleFont = titleFont;
        _defaultFont = defaultFont;
        _logic = new GameOverLogic(0);
    }

    public void SetScore(int score)
    {
        _logic = new GameOverLogic(score);
    }
